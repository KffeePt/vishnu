...
import DocumentViewer from '@/components/ui/collection-structure-visualizer/document-viewer';
...
const SidebarDocumentVizualizer: React.FC<CollectionStructureVisualizerProps> = ({
  collectionName,
  documents,
  isLoading,
  expandedSegments,
...
export default SidebarDocumentVizualizer;